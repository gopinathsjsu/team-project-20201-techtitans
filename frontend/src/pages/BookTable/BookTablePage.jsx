    ...
    try {
      ...
      const filteredResults = allRestaurants.filter((restaurant) => {
        ...
        if (
          ...
          !restaurant.address.toLowerCase().includes(
      ...
      <div className="search-section">
        ...
        <div className="search-form">
          ...
          <input
            ...
            onChange={(e) =>
              setSearchCriteria({ ...searchCriteria, time: e.target.value })
            }
          />
          <input
            type="number"
              ...
              <div className="available-times">
                ...
                <div className="time-slots">
                  ...
                  result.availableTimes[0] === "Restaurant is Closed" ? (
                    ...
                    <>
                      {result.availableTimes.slice(0, 5).map((time, idx) => (
                        <button
                          key={idx}
                      ...
                      {result.availableTimes.length > 5 && (
                        <span className="more-slots-indicator">...</span>
                      )}
                    </>
                  )}
                </div>
